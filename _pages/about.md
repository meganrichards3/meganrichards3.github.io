...
My research focuses on building more scalable, general-purpose statistical tools for problems in causal inference and information theory. My recent focus has been on meta-learning, including learning SOTA algorithms for mutual information estimation ([MIST](https://openreview.net/forum?id=Qi4JgS2PLw)), and leveraging tabular foundation models for causal inference ([SCBench](https://openreview.net/forum?id=9cluMqZFGA)). 
